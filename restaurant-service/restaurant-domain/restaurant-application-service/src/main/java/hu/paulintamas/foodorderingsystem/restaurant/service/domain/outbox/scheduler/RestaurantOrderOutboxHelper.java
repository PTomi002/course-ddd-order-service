...
import hu.paulintamas.foodorderingsystem.restaurant.service.domain.exception.RestaurantDomainException;
...
@Component
@AllArgsConstructor
public class RestaurantOrderOutboxHelper {
    ...
    public void saveOrderOutboxMessage(OrderEventPayload orderEventPayload,
        ...
        save(OrderOutboxMessage.builder()
                ...
                .processedAt(ZonedDateTime.now(Clock.systemUTC()))
