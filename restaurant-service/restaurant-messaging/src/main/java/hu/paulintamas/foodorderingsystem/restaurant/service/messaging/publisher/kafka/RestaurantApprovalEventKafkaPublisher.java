package hu.paulintamas.foodorderingsystem.restaurant.service.messaging.publisher.kafka;
...
import hu.paulintamas.foodorderingsystem.restaurant.service.domain.config.RestaurantServiceConfigData;
...
public class RestaurantApprovalEventKafkaPublisher implements RestaurantApprovalResponseMessagePublisher {
    ...
    public void publish(
        ...
        try {
            var restaurantApprovalResponseAvroModel = restaurantMessagingDataMapper.orderEventPayloadToRestaurantApprovalResponseAvroModel(sagaId, orderEventPayload);
