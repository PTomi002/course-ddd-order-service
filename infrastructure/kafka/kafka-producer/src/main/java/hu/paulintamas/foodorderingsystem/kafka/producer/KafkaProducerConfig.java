...
import hu.paulintamas.foodorderingsystem.kafka.config.data.KafkaConfigData;
import hu.paulintamas.foodorderingsystem.kafka.config.data.KafkaProducerConfigData;
