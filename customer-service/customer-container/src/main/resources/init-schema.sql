...
-- Physical representation of a query, physically stored in disk
...
-- Refreshment statements triggered by "trigger"
...
-- Refresh the materialized view on each data manipulation object on customers table
