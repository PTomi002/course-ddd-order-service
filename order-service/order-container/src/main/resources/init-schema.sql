...
--    VARCHAR + default comparison (COLLATE pg_catalog."default")
...
-- [KNOWLEDGE-OUTBOX] Adding Outbox Tables here
...
(
    ...
    -- Put the payload in a jsonb format into the Outbox Table
    payload jsonb NOT NULL,
    outbox_status outbox_status NOT NULL,
    saga_status saga_status NOT NULL,
    order_status order_status NOT NULL,
    -- For [KNOWLEDGE-LOCKING] Optimistic Locking field
...
-- [KNOWLEDGE] CQRS
-- Read model of customer in order domain.
